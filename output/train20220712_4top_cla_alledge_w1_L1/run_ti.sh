...
#PBS -l select=2:ncpus=68:mpiprocs=1:ompthreads=64
...
OUTDIR=../output/train20220712_4top_cla_alledge_w1_L1
...
cp ../run_ti.sh ../output/train20220712_4top_cla_alledge_w1_L1
echo "training starts!"
mpirun -np $SELECT -env OMP_NUM_THREADS $OMP_NUM_THREADS \
    python train_4top_QCD_cla_resam.py --config config_4top_QCD_w1.yaml \
                                       --epoch $EPOCH --batch $BATCH -o $OUTDIR --cla 1 --model $MODEL --fea 4 --lr $LR --weight 3
