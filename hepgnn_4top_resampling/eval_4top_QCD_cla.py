...
parser.add_argument('--batch', action='store', type=int, default=1, help='Batch size')
...
# print("real_weights", len(real_weights), real_weights)
# print("scales", len(scales), scales)
# print("eval_resampling", len(eval_resampling), eval_resampling)
# print("eval_real", len(eval_real), eval_real)
    
print("preds", len(preds))
print("weights", len(weights))
print("labels", len(labels))
print("real_weights", len(real_weights))
print("scales", len(scales))
print("eval_resampling", len(eval_resampling))
print("eval_real", len(eval_real))
...
# df2 = pd.DataFrame({'real_weight':real_weights, 'eval_resampling':eval_resampling,'eval_real':eval_real})
# fPred2 = 'result/' + args.output + '/' + args.output + '3values.csv'
# df2.to_csv(fPred2, index=False)

# df = pd.DataFrame({'prediction':preds, 'weight':weights, 'label':labels,'scale':scales})
