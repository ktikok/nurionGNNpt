...
class HEPGNNDataset_pt_classify_fourfeature_negative(PyGDataset):
    def __init__(self, **kwargs):
        super(HEPGNNDataset_pt_classify_fourfeature_negative, self).__init__(None, transform=None, pre_transform=None)
        self.isLoaded = False
...
#                 print(len(f[j].x[:]))
                ...
                weightlist.append(real_weights*weight)  
                weightslist = weightslist + real_weights
