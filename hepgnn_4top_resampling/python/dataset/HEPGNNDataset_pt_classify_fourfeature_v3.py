...
class HEPGNNDataset_pt_classify_fourfeature_v3(PyGDataset):
    def __init__(self, **kwargs):
        super(HEPGNNDataset_pt_classify_fourfeature_v3, self).__init__(None, transform=None, pre_transform=None)
        self.isLoaded = False
